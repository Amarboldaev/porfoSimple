...
function loadConfig(countryCode)
{
    $.ajax({
		type : "GET",
        // url: "https://amarboldaev.pythonanywhere.com/assets/config/" + countryCode +  ".json",
        // {{ url_for('static', filename='assets/js/main.js')}}
		url : "static/assets/config/" + countryCode + ".json",
